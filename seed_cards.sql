...
-- The game now uses the original 10x energy scale for every playable card
-- and for the hero-budget values.
...
INSERT INTO actions (
  ...
  ('BishopAttack2', 0, 'slide', 'diag', 1, 1, 2, 0, 1, 0, 0, 0, 0),
  ...
  ('BishopAttack1', 0, 'slide', 'diag', 1, 1, 1, 0, 1, 0, 0, 0, 0),
