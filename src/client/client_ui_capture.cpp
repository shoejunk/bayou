...
constexpr SampleCard SampleCards[] = {
    ...
    {"Maggie Mudroot", "Hero", "cards/maggieMudroot.png", 0, 30, 19, 3, 2, "Undead", "Wild", "Mirewatch", "legendary", "Raise Undead",
     "Raise Undead: return a killed Undead Unit to your hand for free at 1 Health. Its next death exiles it."},
...
const std::vector<std::string>& knownScreens()
{
    static const std::vector<std::string> screens = [] {
        ...
        "conquest",
        "story-select",
        "story-ui-board-unfocused",
        "story-ui-board-hover",
        "story-ui-board-hover-left",
        "story-ui-board-selected",
        "story-ui-board-deselected",
        "story-ui-dialogue-live",
        "story-ui-dialogue-narrator",
        "story-ui-dialogue-off-board",
