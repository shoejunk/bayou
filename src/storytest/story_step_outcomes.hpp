...
inline constexpr StepClaimSpec StepClaims[] = {
    {"mw01_river_teeth", 0, "MOVE REED BACK - FIRST STEP",
        ClaimKind::BasicMove, {}, 0, {"normal-activation", "omni-movement"}},
    {"mw01_river_teeth", 2, "THE GATOR LUNGES", ClaimKind::BasicMove},
    {"mw01_river_teeth", 4, "MOVE REED BACK - SECOND STEP", ClaimKind::BasicMove},
    ...
    {"bt01_harness_hunger", 7, "DISABLE THE GATOR", ClaimKind::StatusApplied,
        "north_gator", 2, {"zero-damage-disable"}},
    {"bt01_harness_hunger", 8, "WATCH DISABLE",
        ClaimKind::StatusAtTurnBoundary, "north_gator", 1},
    {"bt01_harness_hunger", 10, "ONE AXE SWING", ClaimKind::StatusApplied,
    ...
    {"mw03_town_under_company", 3, "RESOURCES AND TAX",
    ...
    {"bt03_sanctuary_debt", 0, "PLAY THE ALCHEMIST", ClaimKind::Deployment,
    ...
    {"bt03_sanctuary_debt", 4, "THAERON - COMMAND", ClaimKind::CommandPending,
        {}, 0, {"command"}},
    {"bt03_sanctuary_debt", 5, "FOREMAN - SUMMON", ClaimKind::CommandedSummon,
        {}, 0, {"summon", "summon-front-square",
            "summoned-unit-arrives-exhausted",
            "command-preserves-normal-activation"}},
    {"bt03_sanctuary_debt", 6, "GROVE SISTER - GLIDE",
        ClaimKind::TrailSpawn, {}, 0, {"trail"}},
    {"bt03_sanctuary_debt", 8, "GAIN RESOURCES", ClaimKind::StartTurnEconomy,
    ...
    {"mw05_watched_office", 3, "MOVE THROUGH THE GUARDS",
    ...
    {"mw06a_card_workshop", 0, "BIRDIE - FORESIGHT", ClaimKind::ForesightDraw,
        {}, 0, {"foresight", "draw-cost"}},
    {"mw06a_card_workshop", 1, "CHOOSE WITH FORESIGHT", ClaimKind::ForesightChoose},
    {"mw06a_card_workshop", 2, "BIRDIE - LONGBOW SHOT", ClaimKind::CooldownApplied,
        {}, 0, {"cooldown"}},
    {"mw06a_card_workshop", 4, "YOUR NEXT TURN",
        ClaimKind::CooldownSkippedActivation, "birdie"},
    {"mw06a_card_workshop", 5, "SCOOTER - RIVER DASH", ClaimKind::RepeatPending,
        {}, 0, {"repeat-lock"}},
    {"mw06a_card_workshop", 6, "SCOOTER - REQUIRED REPEAT", ClaimKind::RepeatFinished},
    {"mw06a_card_workshop", 9, "VETERAN - ADVANCE",
        ClaimKind::SurvivingTargetStagesAttacker, "durable_guard", 0,
        {"attacking-move-survivor-staging"}},
    {"mw06a_card_workshop", 12, "SMUGGLER - FIRST BLADE", ClaimKind::RepeatPending},
    {"mw06a_card_workshop", 13, "SMUGGLER - SECOND BLADE", ClaimKind::RepeatFinished},
    {"mw06a_card_workshop", 16, "SPEARMAN - HOOKED SPEAR",
        ClaimKind::LethalTargetCannotBePulled, "spear_guard", 0,
        {"pull-requires-surviving-target"}},
    {"mw06a_card_workshop", 19, "TRACKER - FROGBACK LEAP",
        ClaimKind::DamageAndAdvance, "durable_guard"},
    {"mw06a_card_workshop", 19, "TRACKER - FROGBACK LEAP",
        ClaimKind::PassThroughAction, {}, 0, {"pass-through"}},
    {"mw06a_card_workshop", 21, "BITE TRIGGERS REBIRTH",
        ClaimKind::RebirthReplacement, "tracker", 0,
        {"rebirth", "normal-enemy-attack"}},
    {"mw06a_card_workshop", 22, "YOUR NEXT TURN",
        ClaimKind::RebirthReplacementReady, "tracker"},
    {"mw06a_card_workshop", 23, "UNMOUNTED TRACKER - SPEAR",
        ClaimKind::BasicAttack, "rebirth_gator", 0, {"dependent-rebirth-action"}},
    {"mw06a_card_workshop", 26, "SCOOTER - RIVER RUSH",
        ClaimKind::DamageAndAdvance, "rush_target"},
    {"mw06a_card_workshop", 29, "SMUGGLER - STEP", ClaimKind::BasicMove},
    {"mw06a_card_workshop", 32, "BIRDIE - SCOUT", ClaimKind::BasicMove},
    ...
    {"mw11_no_plan_saves_all", 8, "JUNIPER TAKES THE ATTACK",
    ...
    {"mw15a_team_workshop", 0, "DEPLOY ON CONTROLLED GROUND",
        ClaimKind::Deployment, "reinforcement", 0,
        {"deployment-cost", "arrival-exhaustion", "card-play-plus-activation"}},
    {"mw15a_team_workshop", 1, "VANYA - BLADE DANCE",
        ClaimKind::RepeatPending, {}, 0, {"repeat-lock"}},
    {"mw15a_team_workshop", 2, "VANYA - COMPLETE THE REPEAT",
        ClaimKind::RepeatFinished},
    {"mw15a_team_workshop", 5, "BIRDIE - LONGBOW SHOT",
        ClaimKind::CooldownApplied},
    {"mw15a_team_workshop", 8, "SPEARMAN - HOOKED SPEAR",
        ClaimKind::LethalTargetCannotBePulled, "spear_guard"},
    {"mw15a_team_workshop", 17, "DONELLA - SPRINT",
        ClaimKind::BasicMove, {}, 0, {"diagonal-movement"}},
    {"mw15a_team_workshop", 20, "DONELLA - MARSHLIGHT MEND",
        ClaimKind::HealingAction, "mend_target", 0, {"friendly-heal", "maximum-health"}},

    {"bt02_customs_bell", 0, "VICTOR - AXE DANCE",
        ClaimKind::RelentlessPending, {}, 0,
        {"relentless-optional-extra-action", "relentless-action-lock"}},
    {"bt02_customs_bell", 1, "VICTOR - EXTRA ATTACK",
        ClaimKind::RelentlessPending},
    {"bt02_customs_bell", 2, "SKIP THE EXTRA ACTION",
        ClaimKind::RelentlessCleared},
    {"bt02_customs_bell", 12, "TAX TAKES AVAILABLE RESOURCES",
        ClaimKind::StartTurnEconomy, {}, 1, {"tax"}},
    {"bt02_customs_bell", 19, "SHARPSHOOTER - ADVANCE",
        ClaimKind::BasicMove, {}, 0, {"state-specific-actions"}},
    {"bt04_terms_conditions", 0, "HIDE THE FIRST AMBUSHER",
        ClaimKind::HiddenNoControl, {}, 0, {"hidden-adds-no-control"}},
    {"bt04_terms_conditions", 4, "SNEAK THROUGH THE GUARDS",
        ClaimKind::PassThroughAction, {}, 0, {"pass-through"}},
    {"bt04_terms_conditions", 7, "HIDE THE SECOND AMBUSHER",
        ClaimKind::HiddenNoControl},
    {"bt04_terms_conditions", 10, "AMBUSH THE HIDDEN SCOUT",
        ClaimKind::HiddenCollision, "erevan"},
    {"bt04_terms_conditions", 13, "AMBUSHER - STAB",
    ...
    {"bt15_monster_rules", 1, "DISABLE: FIRST TURN",
        ClaimKind::StatusAtTurnBoundary, "veteran", 1},
    {"bt15_monster_rules", 2, "THE VETERAN CANNOT ACT",
        ClaimKind::StatusAtTurnBoundary, "veteran", 1},
    {"bt15_monster_rules", 3, "DISABLE: SECOND TURN",
        ClaimKind::StatusAtTurnBoundary, "veteran", 0},
    {"bt15_monster_rules", 4, "DISABLE ENDS",
        ClaimKind::StatusAtTurnBoundary, "veteran", 0, {"status-duration"}},

    {"bt17_natural_order", 0, "VICTOR - AXE DANCE",
        ClaimKind::RelentlessPending, {}, 0,
        {"relentless-optional-extra-action", "relentless-action-lock"}},
    {"bt17_natural_order", 1, "VICTOR - EXTRA ATTACK",
        ClaimKind::RelentlessPending},
    {"bt17_natural_order", 2, "END THE EXTRA ATTACKS", ClaimKind::RelentlessCleared},
    {"bt17_natural_order", 4, "THAERON - COMMAND", ClaimKind::CommandPending,
        {}, 0, {"command", "command-preserves-normal-activation"}},
    {"bt17_natural_order", 5, "FOREMAN - SUMMON", ClaimKind::CommandedSummon,
    ...
    {"bt17_natural_order", 34, "ENTANGLE: FIRST TURN",
        ClaimKind::StatusAtTurnBoundary, "sapling_disable_target", 1},
    {"bt17_natural_order", 35, "THE SAPLING COOLS DOWN",
        ClaimKind::CooldownSkippedActivation, "sapling"},
    {"bt17_natural_order", 35, "THE SAPLING COOLS DOWN",
        ClaimKind::StatusAtTurnBoundary, "sapling_disable_target", 1},
    {"bt17_natural_order", 36, "ENTANGLE: SECOND TURN",
        ClaimKind::StatusAtTurnBoundary, "sapling_disable_target", 0},
    {"bt17_natural_order", 37, "ENTANGLE ENDS",
        ClaimKind::StatusAtTurnBoundary, "sapling_disable_target", 0,
        {"status-duration"}},
    ...
    {"bt17_natural_order", 39, "ASHENFANG: FIRST DISABLED TURN",
        ClaimKind::StatusAtTurnBoundary, "ashenfang_target", 1},
    {"bt17_natural_order", 40, "THE GATOR CANNOT ACT",
        ClaimKind::StatusAtTurnBoundary, "ashenfang_target", 1},
    {"bt17_natural_order", 41, "COLLECTOR - KNIFE STAB",
        ClaimKind::BasicAttack, "collector_target"},
    {"bt17_natural_order", 42, "ASHENFANG: SECOND DISABLED TURN",
        ClaimKind::StatusAtTurnBoundary, "ashenfang_target", 0},
    {"bt17_natural_order", 43, "THE COLLECTOR USES TAX",
        ClaimKind::StatusAtTurnBoundary, "ashenfang_target", 0,
        {"status-duration"}},
    {"bt17_natural_order", 43, "THE COLLECTOR USES TAX",
        ClaimKind::StartTurnEconomy, {}, 1, {"tax"}},
    ...
    {"bt17_natural_order", 62, "AMBUSHER - STAB",
    ...
    {"bt17_natural_order", 68, "AMBUSHER - SNEAK AROUND",
        ClaimKind::PassThroughAction, {}, 0, {"pass-through"}},
    {"bt17_natural_order", 71, "AMBUSHER - AMBUSH",
        ClaimKind::BasicAttack, "collector_target", 0, {"state-specific-actions"}},

    {"se01_cathedral_last_lights", 0, "FLY TO D3",
        ClaimKind::PassThroughAction, {}, 0, {"pass-through"}},
    {"se01_cathedral_last_lights", 3, "FIRE STAR DART",
        ClaimKind::BasicAttack, "fairy_dart", 0, {"line-of-sight"}},
    {"se02_broken_bridge", 1, "HEAL AT END TURN", ClaimKind::HealingAuraTurn,
        {}, 0, {"healing-aura", "maximum-health"}},
    {"se02_broken_bridge", 2, "THE MESSENGER IS HIT",
        ClaimKind::InterceptRedirect, "knight", 1, {"bodyguard", "damage-redirection"}},
    {"se02_broken_bridge", 3, "THE KNIGHT TAKES THE HIT",
        ClaimKind::StatusAtTurnBoundary, "knight", 0},
    {"se02_broken_bridge", 5, "READY NEXT TURN",
        ClaimKind::RebirthReplacementReady, "knight", 1},

    {"se03a_flight_workshop", 0, "FLY PAST THE GRIFFIN", ClaimKind::PassThroughAction,
        {}, 0, {"flying-pass-through"}},
    {"se03a_flight_workshop", 5, "NETTLE RETURNS ON FOOT",
        ClaimKind::RebirthReplacement, "nettle", 0, {"mounted", "rebirth"}},
    {"se03a_flight_workshop", 6, "YOUR NEXT TURN",
        ClaimKind::RebirthReplacementReady, "nettle", 0,
        {"replacement-acts-next-turn"}},
    {"se03a_flight_workshop", 10, "FLY AND ATTACK",
        ClaimKind::SurvivingTargetStagesAttacker, "widow_griffin"},
    {"se03a_flight_workshop", 13, "FLY TO E3",
        ClaimKind::PassThroughAction},

    {"se04_reading_room", 0, "PUT MOSSWAKE INTO PLAY", ClaimKind::Deployment,
        "mosswake", 0, {"deployment-cost", "arrival-exhaustion"}},
    {"se04_reading_room", 1, "DRAW WITH FORESIGHT", ClaimKind::ForesightDraw,
        {}, 0, {"foresight", "draw-cost"}},
    {"se04_reading_room", 2, "CHOOSE FEY MESSENGER", ClaimKind::ForesightChoose},
    {"se04_reading_room", 3, "TRY DISCARDING", ClaimKind::DiscardToBottom,
        {}, 0, {"discard-to-bottom"}},
    {"se04_reading_room", 6, "ATTACK WITH ROOTWALK",
        ClaimKind::DamageAndAdvance, "root_target"},

    {"se07a_queens_price_scene", 0, "MARK THE WARDEN",
        ClaimKind::InfestMarked, "infest_target", 0,
        {"infest-marks-a-surviving-nonhero"}},
    {"se07a_queens_price_scene", 1, "THE MARKED ENEMY IS STILL ALIVE",
        ClaimKind::InfestPersists, "infest_target", 0,
        {"infest-persists-until-target-death"}},
    {"se07a_queens_price_scene", 2, "THE MARK STAYS",
        ClaimKind::InfestPersists, "infest_target"},
    {"se07a_queens_price_scene", 3, "FINISH THE MARKED ENEMY",
        ClaimKind::InfestReplacement, "infest_target", 0,
        {"infest-spawns-allied-unit-on-death", "infestation-replacement-arrives-acted"}},
    {"se07a_queens_price_scene", 6, "MOVE THE QUEEN",
        ClaimKind::BasicMove, {}, 0, {"orthogonal-movement"}},

    {"se07_queens_price", 0, "USE CONTROL",
        ClaimKind::TemporaryControl, "pipes_target", 0,
        {"zero-damage-control", "control-two-turns"}},
    {"se07_queens_price", 3, "HIDE LARK",
        ClaimKind::HiddenNoControl, {}, 0, {"hidden-adds-no-control"}},
    {"se07_queens_price", 6, "SLIP PAST THE BLOCKERS",
        ClaimKind::PassThroughAction, {}, 0, {"pass-through"}},
    {"se07_queens_price", 7, "THE BRISTLEJACK RETURNS",
        ClaimKind::ControlRestored, "pipes_target", 0,
        {"control-restores-at-original-owner-turn-start"}},

    {"se10_no_crown_holds_light", 0, "HEAL THE KNIGHT",
        ClaimKind::HealingAuraTurn, {}, 0, {"healing-aura", "maximum-health"}},
    {"se10_no_crown_holds_light", 5, "CHARM THE BRISTLEJACK",
        ClaimKind::TemporaryControl, "charm_target", 0,
        {"zero-damage-control", "control-two-turns"}},

    {"se13_pearl_and_root", 0, "STRIKE WITH THORNS",
        ClaimKind::StatusApplied, "thorns_target", 2,
        {"positive-damage-disable", "disable-two-turns"}},
    {"se13_pearl_and_root", 1, "WATCH THE FIRST MISSED TURN",
        ClaimKind::StatusAtTurnBoundary, "thorns_target", 1},
    {"se13_pearl_and_root", 2, "ONE TURN MISSED",
        ClaimKind::StatusAtTurnBoundary, "thorns_target", 1},
    {"se13_pearl_and_root", 3, "WATCH THE SECOND MISSED TURN",
        ClaimKind::StatusAtTurnBoundary, "thorns_target", 0},
    {"se13_pearl_and_root", 4, "TWO TURNS MISSED",
        ClaimKind::StatusAtTurnBoundary, "thorns_target", 0, {"status-duration"}},
    {"se13_pearl_and_root", 5, "TRY DEWBELL'S DECREE",
        ClaimKind::StatusApplied, "decree_target", 2,
        {"range-two", "attacking-movement"}},
    {"mw06_cost_seen", 0, "BIRDIE - LONGBOW SHOT", ClaimKind::CooldownApplied,
        {}, 0, {"cooldown"}},
    {"mw06_cost_seen", 2, "COMPANY TURN ENDS",
        ClaimKind::CooldownSkippedActivation, "birdie"},
    {"mw06_cost_seen", 3, "SCOOTER - RIVER DASH", ClaimKind::RepeatPending,
        {}, 0, {"repeat-lock"}},
    {"mw06_cost_seen", 4, "SCOOTER - REQUIRED REPEAT", ClaimKind::RepeatFinished},
    {"mw15_title_follows_burden", 0, "VANYA - BLADE DANCE",
        ClaimKind::RepeatPending, {}, 0, {"repeat-lock"}},
    {"mw15_title_follows_burden", 1, "VANYA - COMPLETE THE REPEAT",
        ClaimKind::RepeatFinished},
    {"mw15_title_follows_burden", 4, "BIRDIE - LONGBOW SHOT",
        ClaimKind::CooldownApplied},
    {"mw15_title_follows_burden", 7, "DONELLA - SPRINT",
        ClaimKind::BasicMove, {}, 0, {"diagonal-movement"}},
    {"mw15_title_follows_burden", 10, "DONELLA - MARSHLIGHT MEND",
        ClaimKind::HealingAction, "mend_target", 0, {"friendly-heal", "maximum-health"}},


    {"se03_road_small_lights", 0, "FLY PAST THE GRIFFIN", ClaimKind::PassThroughAction,
        {}, 0, {"flying-pass-through"}},
    {"se03_road_small_lights", 5, "NETTLE RETURNS ON FOOT",
        ClaimKind::RebirthReplacement, "nettle", 0, {"mounted", "rebirth"}},
    {"se03_road_small_lights", 6, "NETTLE GETS READY",
        ClaimKind::RebirthReplacementReady, "nettle", 0,
        {"replacement-acts-next-turn"}},

};

inline constexpr std::size_t ExpectedOutcomeCheckCount = 172;
...
inline constexpr std::size_t ExpectedAuthoredMasteryClaimCount = 156;
static_assert(
